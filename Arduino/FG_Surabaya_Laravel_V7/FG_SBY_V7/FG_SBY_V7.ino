// ====================================================================
// PROJECT: WiFi Scale System V7.3 (Finished Goods Surabaya)
...
const String DEVICE_TOKEN = "FG-SBY-001";                   
const String MODULE_TYPE = "fg_surabaya"; 
...
bool dataSentForThisObject = false, apiConnected = false;
...
void setup() {
    ...
    lcd.setCursor(0, 0); lcd.print("  FG SURABAYA     ");
...
void syncSettings() {
    ...
    String url = String(SERVER_BASE_URL) + "/api/iot/fg-surabaya/settings?token=" + DEVICE_TOKEN;
...
void sendWeightToLaravel() {
    HTTPClient http; WiFiClient client;
    String url = String(SERVER_BASE_URL) + "/api/iot/fg-surabaya/weight";
