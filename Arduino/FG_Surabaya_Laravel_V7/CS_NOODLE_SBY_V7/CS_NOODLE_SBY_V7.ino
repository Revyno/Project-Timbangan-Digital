// ====================================================================
// PROJECT: WiFi Scale System V7.3 (CS Noodle Surabaya)
...
const String DEVICE_TOKEN = "CS-NOODLE-001";                   
const String MODULE_TYPE = "cs_noodle_sby"; 
...
void setup() {
    ...
    lcd.setCursor(0, 0); lcd.print("  CS NOODLE SBY   ");
...
void syncSettings() {
    ...
    String url = String(SERVER_BASE_URL) + "/api/iot/cs-noodle-sby/settings?token=" + DEVICE_TOKEN;
...
void sendWeightToLaravel() {
    HTTPClient http; WiFiClient client;
    String url = String(SERVER_BASE_URL) + "/api/iot/cs-noodle-sby/weight";
