// ====================================================================
// PROJECT: WiFi Scale System V7.3 (Finished Goods PSN Pasuruan)
...
// --- LARAVEL API CONFIG ---
const char* SERVER_BASE_URL = "http://192.168.10.204:8000"; // IP Server Anda
const String DEVICE_TOKEN = "FG-PSN-001";                   // Token PSN
...
const String MODULE_TYPE = "fg_psn"; 
...
const int MAX_WIFI_RETRIES_BEFORE_RESTART = 2; 
...
void setup() {
    ...
    lcd.backlight();
    lcd.clear();
    lcd.setCursor(0, 0); lcd.print("  TIMBANGAN PSN   ");
...
void syncSettings() {
    HTTPClient http;
    WiFiClient client;
    String url = String(SERVER_BASE_URL) + "/api/iot/fg-psn/settings?token=" + DEVICE_TOKEN;
...
void sendWeightToLaravel() {
    HTTPClient http;
    WiFiClient client;
    String url = String(SERVER_BASE_URL) + "/api/iot/fg-psn/weight";
