// ====================================================================
// PROJECT: WiFi Scale System V7.3 (Incoming RMPM Pasuruan)
...
const String DEVICE_TOKEN = "INC-RMPM-001";                   
const String MODULE_TYPE = "incoming_rmpm"; 
...
void setup() {
    ...
    lcd.backlight();
    lcd.clear();
    lcd.setCursor(0, 0); lcd.print("  INC RMPM        ");
...
void syncSettings() {
    HTTPClient http;
    WiFiClient client;
    String url = String(SERVER_BASE_URL) + "/api/iot/incoming-rmpm/settings?token=" + DEVICE_TOKEN;
...
void sendWeightToLaravel() {
    HTTPClient http;
    WiFiClient client;
    String url = String(SERVER_BASE_URL) + "/api/iot/incoming-rmpm/weight";
...
void showMainPage() {
    lcd.setCursor(0, 0); lcd.print("BR: "); lcd.print(lcdProduk.substring(0, 16));
