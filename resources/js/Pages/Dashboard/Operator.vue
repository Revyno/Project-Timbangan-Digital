                    ...
                    <div v-if="activePenimbangan" class="p-5 bg-emerald-50 border border-emerald-100 rounded-2xl">
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                                <Button @click="nextSession" class="bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl shadow-lg shadow-green-500/20 py-6 px-8">
                                    <RotateCcw class="w-5 h-5 mr-2" />
                                    Ganti Produk
                                </Button>

                                <Button @click="stopSession" variant="destructive" class="bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl shadow-lg shadow-red-200 py-6 px-8">
