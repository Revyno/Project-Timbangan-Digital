...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-black text-gray-800">Pasuruan FG</h2>
            <p class="text-sm text-gray-500 mt-1">Data penimbangan Pasuruan FG (Read Only)</p>
        </div>
    ...
    <div class="p-6 bg-white border border-gray-200 rounded-2xl shadow-sm">
        <form method="GET" action="{{ route('fg.dashboard') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <a href="{{ route('penimbangan.export', request()->all()) }}" 
