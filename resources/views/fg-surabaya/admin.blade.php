...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Data penimbangan formulasi Surabaya (Read Only)</p>
        </div>
    ...
    <div class="p-6 bg-white border border-gray-200 rounded-2xl shadow-sm">
        <form method="GET" action="{{ route('fg-surabaya.dashboard') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <a href="{{ route('fg-surabaya.export', request()->all()) }}" 
            ...
            <div class="flex">
                <a href="{{ route('fg-surabaya.dashboard') }}" 
        ...
        <table class="w-full text-sm text-left text-gray-600">
            ...
            <tbody>
                ...
                <tr class="bg-white/50 border-b border-gray-200 hover transition-colors">
                    ...
                    <td class="px-4 py-3"><span class="font-mono text-xs text-blue-400">{{ $p->kode_produksi_display ?? $p->kode_produksi }}</span></td>
