...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Data penimbangan CS Noodle Surabaya (Read Only)</p>
        </div>
    ...
    <div class="p-6 bg-white border border-gray-200 rounded-2xl shadow-sm">
        <form method="GET" action="{{ route('cs-noodle-sby.dashboard') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <a href="{{ route('cs-noodle-sby.export', request()->all()) }}" 
            ...
            <div class="flex">
                <a href="{{ route('cs-noodle-sby.dashboard') }}" 
